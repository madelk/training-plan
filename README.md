...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/7h9xEkeF8J)
...
```sh
npx nx serve vuetest
```

To create a production bundle:

```sh
npx nx build vuetest
```

To see all available targets to run for a project, run:

```sh
npx nx show project vuetest
```
